...
func connectSignals() -> void:
	_notifications.connect("alarm_permission_status_changed", Callable(self, "_onAlarmPermissionStatusChanged"))
	_notifications.connect("notification_permission_status_changed", Callable(self, "_onNotificationPermissionStatusChanged"))
